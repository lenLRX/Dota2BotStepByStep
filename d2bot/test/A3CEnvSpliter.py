...
class SpliterWarpper:
    ...
    def train(self, labels):
        ...
        loss = self.nll_loss_fn(torch.cat(self.outs),labels)
...
class A3CSpliterEnv(game_env.GameEnv):
    ...
    def train(self):
        ...
        writer.add_scalar("train/policy_loss",policy_loss.item())
        writer.add_scalar("train/policy_loss",value_loss.item())
